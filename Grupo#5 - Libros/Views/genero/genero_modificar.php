...
<body>
    ...
    <div class="textoDerecha" style="overflow-x: auto;">    
        <div class="container">
            ...
            <!-- Formulario -->
            <form id="nuevo" name="nuevo" method="POST" autocomplete="off" action="generoMtto.php?c=Genero&a=actualizar">
                <input type="hidden" id="id" name="id" value="<?php echo $data["genero_id"];?>">
                <!-- Nombre del género -->
                <div class="form-group">
                    <label for="nombre_genero" id="nombre_genero-label">NOMBRE DEL GÉNERO:</label>
                    <input class="form-control" type="text" id="nombre" name="nombre" value="<?php echo $data["genero"]["nombre"];?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="descripcion" name="descripcion" value=""><?php echo $data["genero"]["descripcion"];?></textarea>
                </div>
            <br>
