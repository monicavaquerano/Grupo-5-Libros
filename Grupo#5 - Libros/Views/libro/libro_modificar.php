...
<body>
    ...
    <div class="textoDerecha" style="overflow-x: auto;">    
        <div class="container">
            ...
            <!-- Formulario -->
            <form id="nuevo" name="nuevo" method="POST" autocomplete="off" action="libroMtto.php?c=Libro&a=actualizar">
                <input type="hidden" id="id" name="id" value="<?php echo $data["libro_id"];?>">
                <!-- Título del libro -->
                <div class="form-group">
                    <label for="titulo" id="titulo-label">TÍTULO DEL LIBRO:</label>
                    <input class="form-control" type="text" id="titulo" name="titulo" value="<?php echo $data["libro"]["titulo"];?>">
                </div>
                <!-- Autor del libro ***** dejar con apellido-->
                <div class="form-group">
                    <label for="autor_libro" id="autor_libro-label">AUTOR DEL LIBRO:</label>
                    <select id="dropdown" class="form-control" name="autor" id="autor" required>
                ...
                <div class="form-group">
                    ...
                    <select id="dropdown" class="form-control" name="editorial" id="editorial" required>
                        <option value="" selected disabled>Seleccione:</option>
                        <?php
                ...
                <div class="form-group"> 
                    ...
                    <select id="dropdown" class="form-control" name="pais" id="pais" required>
                        <option value="" selected disabled>Seleccione:</option>
                        <?php
                ...
                <div class="form-group"> 
                    ...
                    <input class="form-control" type="date" id="fecha_publicacion" name="fecha_publicacion" value="<?php echo $data["libro"]["fecha_publicacion"];?>">
                </div>
                <!-- N° de edición -->
                <div class="form-group"> 
                    <label for="edicion" id="edicion-label">N° DE EDICIÓN:</label>
                    <input class="form-control" type="number" min="1" id="edicion" name="edicion" value="<?php echo $data["libro"]["edicion"];?>">
                    
                </div>
                <!-- Género del libro -->
                <div class="form-group"> 
                    <label for="genero_libro" id="genero_libro-label">GÉNERO DEL LIBRO:</label>
                    <select id="dropdown" class="form-control" name="genero" id="genero" required>
                ...
                <div class="form-group"> 
                    ...
                    <select id="dropdown" class="form-control" name="idioma" id="idioma" required>
                        <option value="0" selected disabled>Seleccione:</option>
                        <?php
                ...
                <div class="form-group"> 
                    ...
                    <select id="dropdown" class="form-control" name="portada" id="portada" required>
                        <option value="0" selected disabled>Seleccione:</option>
                        <?php
                ...
                <div class="form-group"> 
                    ...
                    <input class="form-control" type="number" min="1" id="paginas" name="paginas" value="<?php echo $data["libro"]["paginas"];?>">
                </div>
                <!-- ISBN del libro-->
                <div class="form-group"> 
                    <label for="isbn" id="isbn-label">ISBN DEL LIBRO:</label>
                    <input class="form-control" type="text" id="isbn" name="isbn" value="<?php echo $data["libro"]["isbn"];?>">
                </div>
                <!-- Notas adicionales-->
                <div class="form-group"> 
                    <label for="notas" id="notas-label">NOTAS ADICIONALES <span>(Máx. 300 caracteres):</span>:</label>
                    <textarea class="form-control" id="notas" name="notas"><?php echo $data["libro"]["notas"];?></textarea>
                </div>
                <br>
