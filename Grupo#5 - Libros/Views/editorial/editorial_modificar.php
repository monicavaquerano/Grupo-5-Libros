...
<body>
    ...
    <div class="textoDerecha" style="overflow-x: auto;">    
        <div class="container">
            ...
            <!-- Formulario -->
            <form id="nuevo" name="nuevo" method="POST" autocomplete="off" action="editorialMtto.php?c=Editorial&a=actualizar">
                <input type="hidden" id="id" name="id" value="<?php echo $data["editorial_id"];?>">
                <!-- Nombre de la editorial -->
                <div class="form-group">
                    <label for="nombre_editorial" id="nombre_editorial-label">NOMBRE DE LA EDITORIAL:</label>
                    <input class="form-control" type="text" id="nombre" name="nombre" value="<?php echo $data["editorial"]["nombre"];?>">
                </div>
                <!-- País del autor -->
                <div class="form-group"> 
